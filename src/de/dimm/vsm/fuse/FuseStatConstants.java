...
/**
 * User: peter Date: Nov 11, 2005 Time: 10:15:48 AM
 */
public interface FuseStatConstants extends FuseFtypeConstants {
	...
	public static final int OWNER_MASK = 0000700; // mask for file owner
													// permissions
	...
	public static final int OWNER_EXECUTE = 0000100; // owner has execute
														// permission
	...
	public static final int GROUP_EXECUTE = 0000010; // group has execute
														// permission

	public static final int OTHER_MASK = 0000007; // mask for permissions for
													// others
	public static final int OTHER_READ = 0000004; // others have read permission
	public static final int OTHER_WRITE = 0000002; // others have write
													// permisson
	public static final int OTHER_EXECUTE = 0000001; // others have execute
														// permission
}
